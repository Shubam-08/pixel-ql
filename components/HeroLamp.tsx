...
<div className="relative z-20 h-full w-full px-0 py-0 flex items-end justify-start mb-4">
  <div className="flex flex-col items-start ml-2 sm:ml-2 mt-1">
    <motion.h1
      ...
      className={`text-[#f8f1e4] text-base sm:text-xl md:text-3xl font-medium leading-snug tracking-tight drop-shadow-[0_3px_24px_rgba(0,0,0,0.85)] bg-black/30 px-0 py-0 rounded-lg max-w-3xl text-left ${playfair.className}`}
    >
    ...
    <motion.h1
      ...
      className={`text-[#f8f1e4] text-base sm:text-xl md:text-3xl font-medium leading-snug tracking-tight drop-shadow-[0_3px_24px_rgba(0,0,0,0.85)] bg-black/30 px-0 py-0 rounded-lg max-w-3xl mt-2 text-left ${playfair.className}`}
    >
