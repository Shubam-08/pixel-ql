...
export default function AnimatedBackground() {
  return (
    ...
    >
      <div className="absolute -top-40 left-1/2 w-[120vw] h-[80vw] -translate-x-1/2 bg-gradient-to-tr from-blue-700/30 via-yellow-600/30 via-pink-700/30 to-cyan-700/30 blur-[120px] animate-[pulse_8s_ease-in-out_infinite] rounded-full" />
