...
export default function Home() {
  ...
  <div className="flex flex-col h-full">
    <Link href="/projects/sobhatowers" className="block flex-1">
      <div className="bg-gray-800 rounded-3xl overflow-hidden shadow-2xl border border-transparent hover:shadow-cyan-400/40 hover:border-cyan-400 hover:brightness-110 hover:-translate-y-2 transition-all duration-300 h-full min-h-[540px] md:min-h-[700px] flex flex-col">
        <div className="relative w-full h-72 md:h-full aspect-[3/4] md:aspect-auto">
          <Image
          ...
          <div className="absolute bottom-0 left-0 w-full px-6 py-5 bg-gradient-to-t from-black/80 via-black/50 to-transparent flex items-end">
            <h3 className="text-xl md:text-2xl font-semibold text-white/90">Sobha Towers</h3>
          </div>
        </div>
      </div>
    </Link>
